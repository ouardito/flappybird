...
class Bird:
    ...
    def move(self):
        self.tick_count += 1
        d = self.vel *(self.tick_count) + (1/2) * (3) * (self.tick_count)**2
...
class Pipe():
    ...
    def collide(self, bird):
        ...
        top_point  = bird_mask.overlap(bottom_mask, bottom_offset)
...
def draw_window(win, bird, pipes, base, score):
    ...
    text  = SCORE_FONT.render("Score is: " + str(score) , 1, (255,255,255))
...
def main():
    ...
    while run:
        ...
        if bird.y or bird.img.get_height() >= 730:
            pass
